...
export function ServicesSection() {
  return (
    <section className="bg-[#FFFFFF] rounded-t-[40px] sm:rounded-t-[50px] md:rounded-t-[60px] px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32" id="services">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col">
          {services.map((service, index) => (
            <FadeIn delay={index * 0.1} key={service.num} className="border-b-[1px] border-[rgba(12,12,12,0.15)] last:border-b-0 py-8 sm:py-10 md:py-12">
              <div className="flex flex-row items-center sm:items-start md:items-center gap-6 sm:gap-10 md:gap-16">
                <div className="font-black text-[#0C0C0C] text-[clamp(3rem,10vw,140px)] leading-none shrink-0 w-[20%] sm:w-[auto]">
                  {service.num}
                </div>
